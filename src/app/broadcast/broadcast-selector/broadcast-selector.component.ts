...
export class BroadcastSelectorComponent implements OnInit {
  ...
  ngOnInit() {
    this.messageForm = this.formBuilder.group({
      ...
      msgTitle: new FormControl('Test Title', Validators.required),
      msgContents: new FormControl('Test Contents', Validators.required)
    });
    console.log("SlackResponses", this.slackResponses);
  ...
  sendMessage() {
    // console.log(this.messageForm.value.channels);
    // console.log(this.messageForm.value.msgTitle);
    // console.log(this.messageForm.value.msgContents);
